        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">Etablissements de santé</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="#!">Etablissements de santé</a></li>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5> Liste des établissements de santé </h5>
            </div>
            <div class="card-body">
                <div class="row align-items-center m-l-0">
                    ...
                    <div class="col-sm-6 text-end">
                        <a href="{{ route('admin.institutions.create') }}" class="btn btn-success btn-sm mb-3 btn-round"> <i class="fa fa-plus"></i>
                            Ajouter Etablissemnt
                        </a>
                    </div>
                </div>
