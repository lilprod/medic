...
<html lang="fr">
   ...
   <body class="">
      ...
      <div class="pc-mob-header pc-header">
         <div class="pcm-logo">
            <img src="{{asset('assets/admin/assets/images/logo.svg') }}" alt="" class="logo logo-lg">
         </div>
         ...
         <div class="navbar-wrapper">
            <div class="m-header">
               <a href="{{route('dashboard')}}" class="b-brand">
                  ...
                  <img src="{{asset('assets/admin/assets/images/logo.svg') }}" alt="" class="logo logo-lg">
                  <img src="{{asset('assets/admin/assets/images/logo-sm.svg') }}" alt="" class="logo logo-sm">
               </a>
            </div>
            <div class="navbar-content">
               <ul class="pc-navbar">
                 ...
                 <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link "><span class="pc-micon"><i class="material-icons-two-tone">healing</i></span><span class="pc-mtext">Etablissements de santé</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                       <li class="pc-item"><a class="pc-link" href="{{route('admin.institutions.index')}}">Etablissements de santé</a></li>
