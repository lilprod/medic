            ...
            <div class="card-body">
                <div class="row align-items-center m-l-0">
                    ...
                    <div class="col-sm-6 text-end">
                        <a href="{{ route('admin.administrators.create') }}" class="btn btn-success btn-sm mb-3 btn-round" data-toggle="" data-target=""> <i class="fa fa-plus"></i>
                            Ajouter Admin
                        </a>
                    </div>
                </div>
                    ...
                    <table id="simpletable" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.administrators.edit', $user->id) }}" class="btn btn-info btn-sm">Editer</a>
